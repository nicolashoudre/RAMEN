...
class DataModuleMulti(L.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return MultiBatchDataLoader(dataloaders=dls, cycle=False, stop_iteration=self.stop_iteration_train, weights_datasets=self.weights_datasets)
    ...
    def val_dataloader(self):
        ...
        return MultiBatchDataLoader(dataloaders=dls, cycle=False, stop_iteration=self.stop_iteration_val, weights_datasets=self.weights_datasets)
    ...
    def test_dataloader(self):
        ...
        return MultiBatchDataLoader(dataloaders=dls, cycle=False, stop_iteration=None, weights_datasets=self.weights_datasets)

class MultiBatchDataLoader(DataLoader):
    def __init__(self, dataloaders: Dict[str, DataLoader], cycle: bool = True, 
